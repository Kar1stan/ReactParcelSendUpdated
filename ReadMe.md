# ReactParcelSendUpdated

React project - send parcels including deleting and updating them.
...
```
$ git clone https://github.com/Kar1stan/ReactParcelUpdated.git
$ cd ReactParcelUpdated
$ npm install
```
